...
const commonProperties: QmlPropertyDefinition[] = [
  ...
  property('anchors.baseline', 'expression'),
  ...
  property('anchors.horizontalCenterOffset', 'number'), property('anchors.verticalCenterOffset', 'number'),
  property('anchors.baselineOffset', 'number'), property('anchors.alignWhenCentered', 'boolean'),
...
const typeProperties: Record<string, QmlPropertyDefinition[]> = {
  ...
  ApplicationWindow: [
    ...
    property('font.pixelSize', 'number'),
    property('font.pointSize', 'number'),
    property('font.bold', 'boolean'),
    property('font.italic', 'boolean'),
